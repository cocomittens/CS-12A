/*********************************************************************/
/* Program: Days Until Christmas (Bonus)                             */
/* Author: Corrie Gripenstraw (cgripens@ucsc.edu)                    */
/*                                                                   */
/* CMP 12A/L, Winter 2014                                            */
/* Programming Assignment #2 (Bonus)                                 */
/* January 29, 2014                                                  */
/*                                                                   */
/* This program calculates the number of days until Christmas from   */
/* a date which has been input by the user. In addition, it          */
/* displays the day of the week in which Christmas will fall on that */
/* year.                                                             */
/*                                                                   */
/* Input:                                                            */
...
/*                                                                   */
/* Output:                                                           */
/* Date in a readable format (e.g. December 24, 1999),  the          */
/* number of days until Christmas of that year, day of the week      */
/*   of Christmas for that year                                        */
/*                                                                   */
...
public class BonusXMas{
    ...
    /*********************************************************************/
    /* dayofChristmas ( int year )                                       */
    /*                                                                   */
    /* Calculates the day that Christmas will on in the given year       */
    /*                                                                   */
    /* Input: A year between 1600 and 2099                               */          
    /* Output: Day of the week that Christmas falls on that year         */
    /*********************************************************************/   
    public static String dayOfChristmas(int year){
        int century, dayValue = 0, centuryValue = 0;
        int monthDayValue, centuryYearValue, yearTwoDigits;
        century = year / 100;
        ...
        monthDayValue = 2;
        centuryYearValue = (yearTwoDigits % 28) + ((yearTwoDigits % 28) / 4) + centuryValue;
        dayValue = (monthDayValue + centuryYearValue) % 7;
        switch(dayValue){
            case 0:
                return "Saturday";
            case 1:
    ...
    public static void main(String[] args){
        ...
        String dayOfXMas = dayOfChristmas(year);
        ...
        if(month > 12 || month < 1)
            ...
            System.out.println("Date is: " + monthStr + " " + day + ", " + year);
                        if(daysTilXMas != 0){
                            ...
                            System.out.println("Christmas in " + year + " falls on a " + dayOfXMas + ".");
                        }
                        else
